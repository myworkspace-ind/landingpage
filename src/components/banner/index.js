						...
						<div class="carousel-item active">
							...
							<div class="carousel-container">
								<div class="carousel-content">
									<h2>eBook sắp phát hành <br/>"Ứng dụng Phân tích dữ liệu và Trí tuệ nhân tạo với Python"</h2>
									<p>
										Sách dạng file PDF cung cấp cho các bạn kiến thức, kỹ năng về:<br/>Phân tích dữ liệu,<br/>Khoa học dữ liệu.
									</p>
									<p>
										Minh họa bằng ngôn ngữ lập trình Python.
									</p>
									<a href="https://thachln.github.io/ebooks/ung-dung-phan-tich-du-lieu-va-tri-tue-nhan-tao-voi-python/mien-phi-tap-1/" target="_blank" class="btn-get-started scrollto">
										Miễn phí tập 1.
									</a>
								</div>
							</div>
							{/* <div class="carousel-container">
								<div class="carousel-content">
									...
									<h2>Ưu đãi đặc biệt cho người dùng <a href='https://utop.vn/'>UTOP</a>: 99K cho đến hết ngày 1/5/2021</h2>
									<a href="https://myworkspace.vn/ebooks/cham-toi-ai-trong-10-ngay.html" target="_blank" class="btn-get-started scrollto">
										Đọc thử và quét mã ngay
									</a>
								</div>
							</div> */}
						</div>
